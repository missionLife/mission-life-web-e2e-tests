...
describe('Home Page E2E Tests', () => {
  it('should exist', () => {
    expect(() => new HomePage({})).toEqual(jasmine.any(Function));
  });
  ...
  it('should have a Login Page with a Login Button', async () => {
    await page.goto('https://d1s3z7p9p47ieq.cloudfront.net/', { waitUntil: 'domcontentloaded' });
  ...
  describe('uploading', () => {
    ...
    //   const sponsorshipName = 'Juan Felipe Isaza Galviz';
    //   await homePage.selectASponsorship(sponsorshipName);
